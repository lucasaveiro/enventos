...
//
// O progresso aparece em número de parcelas, não em reais: o valor exato já
// pago depende de parcelas + lançamentos avulsos por evento e só é calculado no
// painel lateral, com a mesma regra da v1 — assim a lista nunca mostra um
// número que diverge da tela de evento.
...
export function EventosClient({ events, spaces }: { events: V2Event[]; spaces: V2Space[] }) {
