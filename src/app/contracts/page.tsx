    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div>
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-[var(--foreground)]">Gerador de Contratos</h1>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        {spaces.map((space) => (
          <Link key={space.id} href={`/contracts/${space.id}`} className="group block">
            <div
              className={cn(
                'relative h-full rounded-2xl border-2 border-transparent bg-[var(--card)] shadow-sm',
            ...
            >
              ...
              <p className="text-sm text-[var(--muted-foreground)] mb-4">{space.description}</p>

              <div className="flex items-center gap-1.5 text-xs text-[var(--muted-foreground)] mb-5">
      ...
      <div className="rounded-xl bg-[var(--info-light)] border border-[var(--border)] p-5">
        <h3 className="text-sm font-semibold text-[var(--info-foreground)] mb-2">Como funciona</h3>
        <ol className="text-sm text-[var(--info)] space-y-1.5">
          ...
          <li className="flex items-start gap-2">
            <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[var(--border)] text-[var(--foreground)] text-xs font-bold flex items-center justify-center mt-0.5">4</span>
            Revise e edite cláusula por cláusula conforme necessário
          </li>
          <li className="flex items-start gap-2">
            <span className="flex-shrink-0 w-5 h-5 rounded-full bg-[var(--border)] text-[var(--foreground)] text-xs font-bold flex items-center justify-center mt-0.5">5</span>
