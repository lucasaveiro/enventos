...
export function substituteClause(
  ...
  return content
    ...
    .replace(/{cautionValue}/g, formatCurrency(formData.cautionValue || '') || '[VALOR DA CAUÇÃO]')
...
export const ESTANCIA_AVEIRO_CLAUSES: Omit<ContractClause, 'edited'>[] = [
  ...
  },
  {
    ...
    title: 'DO OBJETO',
    content:
      'O presente contrato tem por objeto a locação de uma chácara de lazer, situada na {spaceFullAddress}. Com direito a escolha de um dos nossos pacotes ({packageType}):\n\n({packageSimpleMark}) Pacote Simples: Cozinha externa equipada com cervejeira, geladeiras, fogão a gás, com gás incluso, churrasqueira, fogão a lenha, forno e ilha com pia. Dois banheiros com chuveiros sendo um para cadeirantes/feminino, e outro masculino (não incluso papel higiênico, sabonetes e papel toalha). O espaço disponibiliza também 13 (treze) mesas e 50 (cinquenta) cadeiras de madeira, guarda-sol para uso na piscina, campo de futebol e estacionamento.\n\n({packageCompleteMark}) Pacote Completo: Inclui todos os itens do pacote simples mais: Casa mobiliada com 3 (Três) salas, sendo uma com mesa de sinuca com 4 (Quatro) tacos, 3 (Três) quartos sendo uma suíte, 2 (Duas) cozinhas, uma copa e uma varanda fechada, 1 (Um) banheiro. A casa possui 23 (vinte e três) acomodações para dormir, sendo 8 (oito) colchões de casal e 7 (sete) de solteiro. A casa disponibiliza também mesas, cadeiras, poltronas, sofás, guarda-roupas, criado mudo, entre outros.\n\n*Chácara possui espaço para no máximo 150 pessoas*\n\nProibido: Tráfego nas propriedades vizinhas à chácara. Trafegar ou estacionar sobre a grama. Objetos cortantes, pontiagudos, copos, latas ou garrafas na região da piscina.\n\nParágrafo Primeiro: Integra o presente contrato, como ANEXO I, o TERMO DE VISTORIA E INVENTÁRIO, documento próprio que relaciona os bens e as condições do imóvel (item, quantidade e estado de conservação). A vistoria será realizada em dois momentos — na entrada e na saída do imóvel —, devendo o termo ser preenchido com registro fotográfico datado e assinado por ambas as partes em cada um desses momentos, fisicamente ou por meio eletrônico (incluindo confirmação por WhatsApp ou e-mail), em sinal de ciência das condições do imóvel e de seus pertences.\n\nParágrafo Segundo: O LOCATÁRIO poderá apontar ressalvas (avarias ou faltas pré-existentes não anotadas na vistoria de entrada) em até 2 (duas) horas contadas do início da ocupação, por escrito, WhatsApp ou e-mail, acompanhadas de fotos. Decorrido esse prazo sem ressalvas, presume-se que o imóvel e seus pertences foram recebidos nas condições descritas no Termo de Vistoria.\n\nParágrafo Terceiro: Se qualquer das partes não comparecer à vistoria de entrada ou de saída, ou se recusar a assinar o respectivo termo, prevalecerá a vistoria realizada pela parte presente, desde que documentada no Termo de Vistoria com registro fotográfico datado, presumindo-se aceita pela parte ausente. A parte ausente poderá contestá-la, por escrito e com evidências, em até 48 (quarenta e oito) horas contadas do recebimento do termo por WhatsApp ou e-mail; não havendo contestação nesse prazo, a vistoria considera-se definitivamente aceita por ambas as partes.\n\nParágrafo Quarto: As divergências apuradas entre a vistoria de entrada e a vistoria de saída constituem prova das avarias, faltas e danos ocorridos durante o período da locação, respondendo o LOCATÁRIO pela sua reparação, com apuração e cobrança na forma da Cláusula Quinta.',
  },
  {
    id: 'periodo',
    number: 'SEGUNDA',
  ...
  },
  {
    ...
    title: 'DA CAUÇÃO E DA GARANTIA CONTRA AVARIAS',
    content:
      'Como garantia da conservação do imóvel e de seus pertences, o LOCATÁRIO pagará ao LOCADOR, a título de caução, o valor de {cautionValue}, com antecedência mínima de 48 (quarenta e oito) horas do horário de entrada, via Pix ou transferência para a conta indicada na Cláusula Quarta, servindo o comprovante de transferência como recibo. A caução destina-se a cobrir eventuais danos causados ao imóvel ou aos seus pertences, faltas apuradas no Termo de Vistoria e Inventário (Anexo I), limpeza extraordinária, multas e demais infrações contratuais cometidas pelo LOCATÁRIO, por seus convidados ou por prestadores de serviço por ele contratados.\n\nParágrafo Primeiro: A entrega das chaves e a liberação do acesso ao imóvel ficam condicionadas à confirmação do pagamento da caução. O não pagamento no prazo estipulado caracteriza inadimplemento do LOCATÁRIO, facultando ao LOCADOR impedir o acesso ao imóvel e aplicar as regras de desistência previstas na Cláusula Quarta, sem que caiba ao LOCATÁRIO qualquer indenização.\n\nParágrafo Segundo: A critério do LOCADOR, a caução em dinheiro poderá ser substituída por pré-autorização (bloqueio) de valor equivalente em cartão de crédito de titularidade do LOCATÁRIO, a ser liberada após a vistoria de saída sem constatação de danos.\n\nParágrafo Terceiro: A caução não se confunde com o valor do aluguel e não poderá ser utilizada pelo LOCATÁRIO para abater parcelas ou qualquer outro pagamento previsto neste contrato.\n\nParágrafo Quarto: Não sendo constatado qualquer dano, falta ou infração na vistoria de saída registrada no Termo de Vistoria e Inventário (Anexo I), a caução será devolvida integralmente ao LOCATÁRIO, via Pix, em conta de sua titularidade, no prazo de até 3 (três) dias úteis contados da saída do imóvel.\n\nParágrafo Quinto: Constatado dano, falta ou infração, o LOCADOR apresentará ao LOCATÁRIO, em até 10 (dez) dias corridos, relatório com registro fotográfico e orçamentos ou notas fiscais dos reparos e reposições, ficando desde já autorizado a deduzir da caução os valores apurados e a devolver o saldo remanescente, se houver, em até 3 (três) dias úteis após a apuração.\n\nParágrafo Sexto: Se os prejuízos apurados excederem o valor da caução, o LOCATÁRIO pagará a diferença no prazo de até 5 (cinco) dias úteis contados da notificação, feita por escrito, e-mail ou WhatsApp, sob pena de multa de 10% (dez por cento), juros de mora de 1% (um por cento) ao mês e correção monetária pelo IPCA, servindo o presente contrato, assinado pelas partes e por 2 (duas) testemunhas, como título executivo extrajudicial, nos termos do art. 784, III, do Código de Processo Civil, podendo o débito, ainda, ser protestado e inscrito nos cadastros de proteção ao crédito.',
  },
  {
    id: 'local',
    number: 'SEXTA',
  ...
  },
  {
    ...
    content:
      'Fica, desde já, acordado que toda a responsabilidade sobre as pessoas que irão frequentar o local, é do LOCATÁRIO, tanto no que se refere a eventuais danos causados por estes ao local ou a seus equipamentos, quanto a eventuais acidentes.\n\nParágrafo Primeiro: Assume ainda, o LOCATÁRIO, toda a responsabilidade com relação à guarda e assistência de menores desacompanhados dos pais, bem como quaisquer problemas com relação a estes ou ainda aos maiores. Isto devido a abranger, o presente contrato, somente a locação do espaço objeto da Cláusula Primeira.\n\nParágrafo Segundo: O LOCATÁRIO responde pelos danos e faltas causados por seus convidados, familiares, prestadores de serviço e fornecedores que acessarem o imóvel em razão da locação, independentemente da identificação do causador direto do dano, sendo os prejuízos apurados e cobrados na forma da Cláusula Quinta.',
  },
  {
    id: 'uso',
    number: 'OITAVA',
